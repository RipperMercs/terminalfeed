...
export const ALL_PANELS = [
  ...
  { id: 'seismic-timeline', label: 'Seismic Timeline', defaultSpan: 1 },
  ...
  { id: 'cert-stream', label: 'Cert Stream', defaultSpan: 1 },
  { id: 'btc-difficulty', label: 'BTC Difficulty', defaultSpan: 1 },
  { id: 'congress', label: 'US Congress', defaultSpan: 1 },
  { id: 'lightning', label: 'Lightning Network', defaultSpan: 1 },
  { id: 'bsky-firehose', label: 'Bluesky Firehose', defaultSpan: 1 },
  { id: 'neo', label: 'Near Earth Objects', defaultSpan: 1 },
  { id: 'defi-tvl', label: 'DeFi TVL', defaultSpan: 1 },
  ...
  { id: 'fireballs', label: 'Fireball Log', defaultSpan: 1 },
...
{ id: 'daily-paws', label: 'Daily Paws', defaultSpan: 1 },
  ...
  // Ops & Alerts cluster (July 18 2026)
  { id: 'trade-halts', label: 'Trade Halts', defaultSpan: 1 },
  { id: 'faa-status', label: 'Airspace (FAA)', defaultSpan: 1 },
